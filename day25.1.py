...
def transform(loopSize, subjectNum, startVal=1):
	val=startVal;
...
for text in fInput:
	...
	# for subjectNum in range(1, 100):
	# 	cardLoop = None;
	# 	doorLoop = None;
	# 	for loop in range(1000):
	# 		if transform(loop, subjectNum) == cardKey:
	# 			cardLoop = loop;
	# 			break;
	#
	# 	for loop in range(1000):
	# 		if transform(loop, subjectNum) == doorKey:
	# 			doorLoop = loop;
	# 			break;
	# 	if doorLoop is not None and cardLoop is not None:
	# 		break;

	# for loop in range(1000):
	# 	if transform(loop, 7) == cardKey:
	# 		cardLoop = loop;
	# 		break;
	#
	# for loop in range(1000):
	# 	if transform(loop, 7) == doorKey:
	# 		doorLoop = loop;
	# 		break;
	...
	curVal = 1;
	while True:
		curVal = transform(1, 7, startVal=curVal);
		cardLoop += 1;
		if curVal == cardKey:
			break;
	...
	answer = transform(doorLoop, cardKey);
	print(transform(cardLoop, doorKey));
